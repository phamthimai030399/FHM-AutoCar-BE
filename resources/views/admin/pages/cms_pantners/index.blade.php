  ...
  <section class="content">
      ...
      <form action="{{ route(Request::segment(2) . '.index') }}" method="GET">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>@lang('Pantner category')</label>
    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">@lang('Pantner list')</h3>
      </div>
                ...
                @if ($row->parent_id == 0 || $row->parent_id == null)
                  <form action="{{ route(Request::segment(2) . '.destroy', $row->id) }}" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      @php
                        $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['pantner'], $row->alias ?? $row->title, $row->id, 'detail', $row->taxonomy_title);
                      @endphp
                      <td>
