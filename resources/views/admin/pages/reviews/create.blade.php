                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control">
                                                <label>
                                                    <input type="radio" name="type" value="1" checked class="ck_ty">
                                                    <small>Tin cho thuê</small>
                                                </label>
                                                <label>
                                                    <input type="radio" name="type" value="2" class="ml-15 ck_ty">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="json_user[name]"
                                                placeholder="Tên người tạo" value="">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="bedrooom"
                                                placeholder="Số phòng ngủ" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="bathrooom"
                                                placeholder="Số phòng tắm" value="">
                                        </div>
                                    </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="defautu_space mb-3 form-group">
                                                <input type="text" class="form-control form-group" name="json_product[space][]"
                                                    placeholder="Nhập không gian" value="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="defaunt_convenient row">
                                                ...
                                                <div class="col-md-9 form-group">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        placeholder="Nhập tiện nghi" value="">
                                                </div>
                                            </div>
                                        </div>
