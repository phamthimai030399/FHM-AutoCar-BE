                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="json_params[price]"
                                                placeholder="<?php echo app('translator')->get('Discount price'); ?>" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Title top'); ?></label>
                                            <input type="text" class="form-control" name="json_params[title_top]"
                                                placeholder="<?php echo app('translator')->get('Title top'); ?>" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[brief][vi]" class="form-control"
                                                id="brief_vi"><?php echo e(old('json_params[brief][vi]')); ?></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FHM\FHM-AutoCar-BE\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>