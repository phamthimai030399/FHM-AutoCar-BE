<?php if($block): ?>
    <?php
        ...
        $url_link_button = $block->json_params->url_link_button ?? $block->url_link_button;
                                            ...
                                            <div class="product-item p-md-3">
                                                <div class="position-relative box-product-image">
                                                    <img class="product-best-seller-image" width=""
                                                        src="<?php echo e($image); ?>" alt="product-best-seller" />
...
<?php endif; ?>
<?php /**PATH D:\FHM\FHM-AutoCar-BE\resources\views/frontend/blocks/cms_product/styles/best_seller.blade.php ENDPATH**/ ?>