            ...
            <div class="carousel-inner">
                <?php if($block_childs): ?>
                    <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="carousel-item active" style=" background: url(<?php echo e($image_for_screen); ?>); background-size: 100% 100%; height: 100%; ">
                            <div class="container">
                                <div class="frame">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\yoga\resources\views/frontend/blocks/banner_video/styles/slide.blade.php ENDPATH**/ ?>