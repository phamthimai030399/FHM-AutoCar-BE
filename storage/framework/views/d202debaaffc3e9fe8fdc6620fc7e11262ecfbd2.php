                                                                    ...
                                                                    <div class="tab-pane active">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label><?php echo app('translator')->get('Content'); ?></label>
                                                                                    <textarea name="content"  class="form-control" rows="5"><?php echo e(old('content') ?? $item->content); ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select name="json_params[style]" id="block_style" class="form-control select2"
                                                                                        ...
                                                                                        <?php $__currentLoopData = $blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <?php if($item_block->block_code == $item->block_code): ?>
                                                                                                <?php
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-md-6">
                                                                                                    <div
                                                                                                        class="form-group">
                                                                                                        <label><?php echo app('translator')->get('Brief'); ?></label>
                                                                                                        <textarea name="brief"  class="form-control" rows="5"><?php echo e(old('brief') ?? $item_sub_1->brief); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FHM\FHM-AutoCar-BE\resources\views/admin/pages/block_contents/edit/custom.blade.php ENDPATH**/ ?>