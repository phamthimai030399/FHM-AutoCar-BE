        ...
        <div class="product-popular-banner">
            <div class="container">
                <div class="d-flex flex-column product-popular-banner-content">
                    <span class="product-popular-banner-content-top"><?php echo e($title); ?></span>
                    <span class="product-popular-banner-content-bottom"><?php echo e($brief); ?></span>
                    <?php echo e($content); ?>

                </div>
            </div>
            <img src="<?php echo e($background); ?>" alt="" />
        </div>
            ...
            <div class="container d-flex justify-content-between flex-wrap">
                ...
                <div class="product-item p-md-3">
                    <div class="position-relative">
                        <img class="product-best-seller-image" width="" src="<?php echo e($image); ?>"
                    ...
                    <div class="text-start mt-3">
                        <div class="brand-name"><?php echo e($title_top); ?></div>
                        <h3><?php echo e($title); ?></h3>
                        <p><?php echo e($brief); ?></p>
                        <div class="btn-price">
                            <div class="my-3">
                                <span class="current-price"><?php echo e($price); ?></span>
                                <span class="origin-price"><?php echo e($price_old); ?></span>
                            </div>
...
<?php endif; ?>
<?php /**PATH D:\FHM\FHM-AutoCar-BE\resources\views/frontend/blocks/cms_product/styles/list_product.blade.php ENDPATH**/ ?>